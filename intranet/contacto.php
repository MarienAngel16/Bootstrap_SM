...
<div class="container mt-6">
    <div class="row">
        ...
        <div class="col-md-6">
        <img class="img-fluid" src="../img/ilus2.png" alt="">
        </div>
        <div class="col-md-6">
            <!-- Contenido de la segunda columna -->

            <h2>Horarios de Misa</h2>
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Debitis dolorem exercitationem nihil magnam dolor voluptate in est nesciunt alias, iste voluptatem ipsum fuga vel iusto tempora! Praesentium sed facilis doloribus.</p>
            <ul>
            <li>7 am</li>
            <li>8 am</li>
            <li>9 am</li>
